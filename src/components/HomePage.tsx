...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Monitor your prediction accuracy and improve over time",
...
export function HomePage({ onGetStarted, onExplorePredictions, onViewHotTakes, onArticleClick, articles, user }: HomePageProps) {
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Everything you need to make informed predictions and compete with the best
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Select from specialized agents in crypto, tech, politics, and more
              </p>
            </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <p className="text-xl text-muted-foreground">
              Join thousands of users making informed predictions with AI-powered insights
            </p>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <Card className="relative overflow-hidden">
            <div className="absolute inset-0"
              style={{
                background: "linear-gradient(160deg, #007CF0 0%, #0677e2 30%, #07c1bb 49%, #07c1bb 51%, #0677e2 70%, #007CF0 100%)"
              }} />
            <div className="relative px-8 py-12 md:py-16 px-6 text-center text-white space-y-6">
              ...
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Join the future of AI-powered predictions today. Start with 5 free
                predictions on our Basic tier.
              </p>
