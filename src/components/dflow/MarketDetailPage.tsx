                          ...
                          <h1 className="text-lg md:text-xl font-bold w-full">
                            ...
                            <Badge
                              ...
                              className={`text-[10px] ml-3 px-1.5 py-0 h-6 capitalize shrink-0 ${
                                getStatusBadgeProps(dflowMarket.status)
                                  .className
                              }`}
                            >
                              {dflowMarket.status}
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        <div className="rounded-lg border bg-card">
                          <div className="px-4 py-3 border-b flex items-center justify-between">
                            ...
                            <span className="text-xs text-muted-foreground">
                              Bid {safePrice(dflowMarket.yesBid)} / Ask{' '}
                        ...
                        <div className="rounded-lg border bg-card">
                          <div className="px-4 py-3 border-b flex items-center justify-between">
                            ...
                            <span className="text-xs text-muted-foreground">
                              Bid {safePrice(dflowMarket.noBid)} / Ask{' '}
                      ...
                      {dflowMarket.rulesPrimary ? (
                        ...
                        <div className="pt-4">
                          ...
                          <p className="text-muted-foreground whitespace-pre-wrap">
                            ...
                            resolve to "YES" if the outcome specified in the
                            title occurs by the event’s official conclusion.
                            Otherwise, the market will resolve to "NO". <br />{' '}
                            <br />
                            Trading for this market will be locked at the close
                            time listed above. After the event has concluded,
                            the market will be resolved based on publicly
                            available and verifiable information from reliable
                            sources.
                            <br />
                            <br />
                            Please note that this market is intended for
                            prediction and trading purposes only. Prices reflect
                            the market’s implied probability and do not
